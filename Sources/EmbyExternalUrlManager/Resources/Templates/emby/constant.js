...
const embyHost = {{EMBY_SERVER_URL}};
const embyApiKey = {{EMBY_API_KEY}};
const mediaMountPath = {{MEDIA_MOUNT_PATHS}};

function getEmbyHost(r) { return embyHost; }
function getTranscodeEnable(r) { return transcodeConfig.transcodeConfig.enable; }
function getTranscodeType(r) { return transcodeConfig.transcodeConfig.type; }
function getImageCachePolicy(r) { return extConfig.imageCachePolicy; }
